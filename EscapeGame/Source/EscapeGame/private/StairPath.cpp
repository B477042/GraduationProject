...
void AStairPath::SettingWorldMatrix()
{
	...
	Wall4->SetRelativeLocation(FVector(X = -230.000000f, Y = -500.000000f, Z = 0.000000f));
	...
	Wall5->SetRelativeLocation(FVector(X = -230.000000f, Y = -130.000000f, Z = 420.000000f));
	...
	Stair1->SetRelativeLocation(FVector(X = 0.000000f, Y = 30.000000f, Z = 0.000000f));
	...
	Stair2->SetRelativeLocation(FVector(X = -170.000f, Y = -300.0000f, Z = 150.000000f));
