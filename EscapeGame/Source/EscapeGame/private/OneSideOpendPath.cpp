...
#include "DecoActor/OneSideOpendPath.h"
...
AOneSideOpendPath::AOneSideOpendPath()
{
	...
	//(X=-330.000000,Y=10.000000,Z=0.000000)
	//(Pitch=0.000000,Yaw=90.000000,Roll=0.000000)
	MiddleWall->SetRelativeLocation(FVector(-330.0f, 10.0f, 0.0f));
...
void AOneSideOpendPath::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
//void AOneSideOpendPath::Tick(float DeltaTime)
//{
