...
void AStairPath2::SettingWorldMatrix()
{
	...
	Wall4->SetRelativeLocation(FVector(X = -230.000000, Y = -160.000000, Z = 0.000000+AdjustmentValue));
	...
	Wall5->SetRelativeLocation(FVector(X = -230.000000, Y = -460.000000, Z = 420.000000+AdjustmentValue));
	...
	Stair1->SetRelativeLocation(FVector(X = 0.000000, Y = -300.000000, Z = 0.000000+AdjustmentValue));
	...
	Stair2->SetRelativeLocation(FVector(X = -170.000000, Y = 30.000000, Z = 150.000000+AdjustmentValue));
